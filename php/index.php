    ...
    <header>
        ...
        <div class="presentation">
            <p>
                ...
                <br>
                <br>
                Envie de partir à l'aventure avec des anciens compagnons ou des malotrus de la taverne ? Nous avons des salles pour vous ! 
                <br>
                <br>
                Vous pouvez vous concertez en petit comité dans des chambres privés prévus à cet effet. 
                Même si ces salles sont privés, n’oubliez pas que le tavernier peut vous jeter à la geôle si vous être trop perturbant.
                <br>
                <br>
                Si vous voulez vous détendre devant un petit jeu de société, nous avons créer pour vous des petits jeux à jouer à 2 pas piquer des hannetons.
                Mais si vous voulez vous projetez dans une aventure EXCEPTIONNELLE, ÉPIQUE, JOUISSIVE, nous avons des salons privés ou nous vous proposons 
                des thèmes de départ ainsi que des débuts d'aventures, à vous d'imaginer la suite !
                <br>
                <br>
                Dans cette taverne, pas de pourparlers ! Si vous êtes jugés comme insultant ou contre le règlement, 
